...
# Define the layout
San_diego_layout = dbc.Container([
    # dbc.Row([
    #     dbc.Col([
        ...
        dbc.Col([
         ...
         dbc.Col([
              dbc.Card([
                   ...
                   dbc.CardBody(id='card-content3',children=[], className='custom-card-body1')
    ...
    dbc.Row([
         dbc.Col([
              dcc.Graph(id='box_plot3', figure={}, className='graph-padding')
         ], width= 12)
    ]),
...
@app.callback(
    ...
    #  Output(map_chart1, 'figure'), 
     ...
     Output(map_chart2, 'figure'), Output('card-content3', 'children'),
     Output('box_plot3', 'figure')
     ],
