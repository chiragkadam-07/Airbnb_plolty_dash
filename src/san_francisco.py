...
df = pd.read_csv("C:/Users/sahil/Downloads/New folder/San_Francisco_subset.csv")
...
# Define the layout
San_Francisco_layout = dbc.Container([
    # dbc.Row([
    #     dbc.Col([
        ...
        dbc.Col([
         ...
         dbc.Col([
              dbc.Card([
                   ...
                   dbc.CardBody(id='card-content2',children=[], className='custom-card-body1')
    ...
    dbc.Row([
         dbc.Col([
              dcc.Graph(id='box_plot2', figure={}, className='graph-padding')
         ], width= 12)
    ]),
...
@app.callback(
    ...
    #  Output(map_chart1, 'figure'), 
     ...
     Output(map_chart2, 'figure'), Output('card-content2', 'children'),
